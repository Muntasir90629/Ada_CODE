...
for i in range(0,c,1):
  ...
  df_em=ctg_ifa.join(df_em,'ifa','outer')

df_em=df_em.distinct()
df_em.count()


df_em.coalesce(1).write.csv('s3a://ada-bd-emr/muntasir/bus/bus3/ctg/april/', mode='overwrite', header=True)


df_em.coalesce(1).write.csv('s3a://ada-bd-emr/muntasir/bus/bus3/ctg/may/', mode='overwrite', header=True)
