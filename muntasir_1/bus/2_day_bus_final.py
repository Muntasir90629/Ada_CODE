...
df_em.coalesce(1).write.csv('s3a://ada-bd-emr/muntasir/bus/bus3/allcount/april/', mode='overwrite', header=True)

df_em.coalesce(1).write.csv('s3://ada-bd-emr/muntasir/bus/bus3/allcount/may/', mode='overwrite', header=True)
