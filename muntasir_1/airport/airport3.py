...
df=spark.read.parquet('s3a://ada-prod-data/etl/data/brq/agg/agg_brq/daily/BD/2022{0504}/*.parquet')
...
dhaka_air_ifa=dhaka_air_ifa.withColumnRenamed('geohash','geohash_dhaka')
...
ctg_air_ifa=ctg_air_ifa.withColumnRenamed('geohash','geohash_chittagong')
