...
df_brq=spark.read.parquet('s3a://ada-prod-data/etl/data/brq/agg/agg_brq/daily/BD/2021{0413,0414,0415,0416,0417,0418,0419,0420,0421,0422,0423,0424,0425,0426,0427,0428,0429,0430}/*.parquet')
...
df_gender = spark.read.parquet('s3a://ada-prod-data/etl/table/brq/sub/demographics/monthly/BD/2021{04}/gender/*.parquet')
df_gender.printSchema()
df_gender=df_gender.select('ifa','label')
df_gender=df_gender.withColumnRenamed('label','gender')
df_gender.show()
df_age = spark.read.parquet('s3a://ada-prod-data/etl/table/brq/sub/demographics/monthly/BD/2021{04}//age/*.parquet')
...
df_gps_gender_age=df_gps_gender_age.filter(df_gps_gender_age.gender != 'null')
df_gps_gender_age=df_gps_gender_age.filter(df_gps_gender_age.geohash != 'null')
df_gps_gender_age=df_gps_gender_age.filter(df_gps_gender_age.time !='null') 
df_gps_gender_age=df_gps_gender_age.filter(df_gps_gender_age.bundle !='null')
df_gps_gender_age=df_gps_gender_age.filter(df_gps_gender_age.asn !='null')
...
affluence=spark.read.parquet('s3a://ada-prod-data/etl/data/brq/sub/affluence/monthly/BD/2021{04}/*.parquet')


#affluence=spark.read.parquet('s3a://ada-prod-data/etl/data/brq/sub/affluence/daily/BD/2021{0413,0414,0415,0416,0417,0418,0419,0420,0421,0422,0423,0424,0425,0426,0427,0428,0429,0430,0501,0502,0503,0504,0505,0506,0507,0508,0509,0510,0511,0512}/*.parquet')
...
df_gender_age_affluence=df_gender_age_affluence.filter(df_gender_age_affluence.affluence!='null')
df_gender_age_affluence=df_gender_age_affluence.filter(df_gender_age_affluence.gender!='null')
df_gender_age_affluence=df_gender_age_affluence.filter(df_gender_age_affluence.age!='null')
df_gender_age_affluence=df_gender_age_affluence.filter(df_gender_age_affluence.geohash !='null')
df_gender_age_affluence=df_gender_age_affluence.filter(df_gender_age_affluence.time!='null')
df_gender_age_affluence=df_gender_age_affluence.filter(df_gender_age_affluence.asn !='null')
df_gender_age_affluence=df_gender_age_affluence.filter(df_gender_age_affluence.bundle !='null')
...
df_gender_age_affluence_6_22=df_gender_age_affluence_6_22.filter(df_gender_age_affluence_6_22.bundle !='null')
df_gender_age_affluence_6_22=df_gender_age_affluence_6_22.filter(df_gender_age_affluence_6_22.ifa !='null')
df_gender_age_affluence_6_22=df_gender_age_affluence_6_22.filter(df_gender_age_affluence_6_22.affluence !='null') 
df_gender_age_affluence_6_22=df_gender_age_affluence_6_22.filter(df_gender_age_affluence_6_22.gender !='null') 
df_gender_age_affluence_6_22=df_gender_age_affluence_6_22.filter(df_gender_age_affluence_6_22.age !='null')
df_gender_age_affluence_6_22=df_gender_age_affluence_6_22.filter(df_gender_age_affluence_6_22.time !='null')

df_gender_age_affluence_6_22=df_gender_age_affluence_6_22.filter(df_gender_age_affluence_6_22.asn !='null')
