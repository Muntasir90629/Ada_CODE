...
master_poi=spark.read.csv('s3a://ada-bd-emr/muntasir/POI/bd_poi_master_v7.0.csv',header=True)
master_poi=master_poi.select('level_id','name','geohash')
...
df_uh__h_jewellery=df_uh_h.join(jewellers_poi,'geohash','left')
...
df_uh__h_pharma=df_uh_h.join(pharma_poi,'geohash','left')
...
df_uh_h_club=df_uh_h.join(poshclub_poi,'geohash','left')
