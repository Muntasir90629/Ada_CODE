...
df=spark.read.parquet('s3a://ada-prod-data/etl/data/brq/agg/agg_brq/monthly/BD/2022{09,10}/*.parquet')
...
affluence=spark.read.parquet('s3a://ada-prod-data/etl/data/brq/sub/affluence/monthly/BD/2022{07,08}/*.parquet')
...
df2_aff=df2_aff.withColumnRenamed("ifa","Mobile Device ID")



df2_aff.printSchema()

df2_aff.coalesce(12).write.csv('s3a://ada-bd-emr/result/2022/Jago/DSR-794/data-refresh/multiple/', mode='overwrite', header=True)



df=spark.read.csv('s3a://ada-bd-emr/result/2022/Jago/DSR-794/data-refresh/multiple/*.csv',header=True)
