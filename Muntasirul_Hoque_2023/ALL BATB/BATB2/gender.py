...
zone=thana_ifa_uh.filter(thana_ifa_uh.thana.isin(C))
...
df_age = spark.read.parquet('s3://ada-prod-data/etl/data/brq/sub/age/monthly/BD/2023{04}/*.parquet')
df_age = df_age.withColumnRenamed('prediction', 'gender')
# 
