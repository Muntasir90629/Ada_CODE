...
a =level_df.select('app_l1_name').distinct()
...
app = simu.join(brq2, on='bundle', how='left').cache()
app.printSchema()
...
app.coalesce(1).write.csv('s3a://ada-bd-emr/muntasir/BATB/simu_app/', mode='overwrite', header=True)
